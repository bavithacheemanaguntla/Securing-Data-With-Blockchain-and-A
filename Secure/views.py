...
def PatientLogin(request):
    if request.method == 'POST':
      ...
      con = pymysql.connect(host='localhost',user = 'root', password = 'Sreethu@12345', database = 'SecuringData')
      with con:
          cur = con.cursor()
...
def updateRevenue(value):
    db_connection = pymysql.connect(host='localhost',user = 'root', password = 'Sreethu@12345', database = 'SecuringData')
